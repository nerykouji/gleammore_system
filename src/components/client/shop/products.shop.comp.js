    ...
    return (
        ...
        <section>
            <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                <header>
                    <h2 className="text-xl font-bold text-gray-900 sm:text-3xl">Explore the Best PC Parts for Your Next Build</h2>

                    <p className="mt-4 max-w-md text-gray-500">
                        Discover top-quality components that elevate your gaming and productivity experience. Whether you`re a seasoned enthusiast or just starting out, our curated selection of PC parts ensures you find the perfect match for your needs. Upgrade your setup today and unleash the full potential of your machine!
                    </p>
                </header>
