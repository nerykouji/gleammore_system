...
import { useUpdateProductBackend } from '@/db.supa.backend/products.backend';

const EditAdminProductComp = ({ selectedProduct, setEditing, handleRefresh }) => {
    const [images, setImages] = useState([]);
    const { loading, updateProduct } = useUpdateProductBackend();
...
export default EditAdminProductComp;